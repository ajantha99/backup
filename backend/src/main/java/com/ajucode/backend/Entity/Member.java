...
public class Member {
    ...
    @Column(name = "Member_fname", length = 255)
    private String memberfname;
    @Column(name = "Member_mname", length = 255)
    private String membermname;
    @Column(name = "Member_lname", length = 255)
    private String memberlname;

    @Column(name = "Member_bdate", length = 15)
    private int bdate;
    @Column(name = "Member_gender", length = 25)
    ...
    @Column(name = "conform_password", length = 255)
    private String cpassword;

    @Column(name = "personal_email", length = 255)
    private String pemail;
    @Column(name = "aiesec_email", length = 255)
    ...
    @Column(name = "front_office_funtion", length = 255)
    private String fofunction;
    @Column(name = "front_office_position", length = 255)
    private String foposition;

    @Column(name = "back_office_funtion", length = 255)
    private String bofunction;
    @Column(name = "back_office_position", length = 255)
    private String boposition;

    @Column(name = "join_date_aiesec", length = 15)
    private int joindate;
    @Column(name = "OEVP_name", length = 225)
    private String oevpname;
    @Column(name = "TL/Manager_name", length = 225)
